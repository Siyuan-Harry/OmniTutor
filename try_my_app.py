...
def app():
    ...
    with st.session_state.start_col2:
        ...
        - 请捐款支持。因为每位用户的每次课程生成，都会产生一定的成本。个人开发者生存不易。
        - Please donate to support. Because each course generated by each user will incur a certain cost. 
                                                
        <img src="https://siyuan-harry.oss-cn-beijing.aliyuncs.com/oss://siyuan-harry/20231110145229.png"/, height = "75">
                                                
        ### Contact me 联系我 
        
        以下是开发者 @何思远方Siyuan 欢迎联系
